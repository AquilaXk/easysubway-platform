...
require_nonempty EASYSUBWAY_JOURNEY_SEARCH_TIMEOUT
require_nonempty EASYSUBWAY_JOURNEY_MAX_SEARCHES_PER_SESSION
require_nonempty EASYSUBWAY_JOURNEY_SESSION_CERTIFICATE_SHA256
